...
module.exports = (client) => {
  ...
  setInterval(() => {
    ...
    client.user.setActivity("Watching Giveaways", { type: "WATCHING" });
  }, 20000);

};

 client.user.setActivity("My Prefix Is e!", { type: "WATCHING" });
  }, 20000);

};

 client.user.setActivity("Watching Out For e!help", { type: "WATCHING" });
  }, 20000);
